...
public class Navigation {
	...
	/**
	 * rotate ultrasonic sensor towards 90 degrees
	 */
	public void orientSensorNorth(){
		
		int theta = (int) odometer.getAng();
		int limitAng = 0;
		...
		if(theta > 350){
			limitAng = -90 - 360 + theta;
		}
		if(theta > 90 && theta < 190){
			limitAng = theta - 90;
		}
		if(theta == 90){
			limitAng = 0;
		...
		sensorMotor.rotateTo(limitAng, true);
	}
